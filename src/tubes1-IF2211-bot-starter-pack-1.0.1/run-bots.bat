@echo off
@REM start cmd /c "python main.py --logic MyBot --email=test@email.com --name=stima --password=123456 --team etimo"
start cmd /c "python main.py --logic MyBot --email=test1@email.com --name=botol --password=123456 --team etimo"
